...
public partial class TrpTrnKazView
{
    ...
    public decimal? TtvKursL { get; set; }

    public decimal? TtvKursM { get; set; }
    ...
    public short? TtvBosDc { get; set; }

    public decimal? TtvBoskwota { get; set; }

    public int? TtvTrpFormaNr { get; set; }

    public int? TtvKazTyp { get; set; }

    public int? TtvRodzaj { get; set; }

    public byte? TtvRozliczona { get; set; }

    public decimal? TtvPozostaje { get; set; }

    public int? TtvZaksiegowano { get; set; }

    public int? TtvNieKsiegowac { get; set; }

    public int? TtvDataRozliczenia { get; set; }
}
