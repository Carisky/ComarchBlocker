...
public partial class SPomOpisyAnalityczne
{
    ...
    public int? PomWymNazwa { get; set; }
    ...
    public string? PomWymWymCentrumOrgId { get; set; }

    public string? PomWymWymLokalizacjaOrgId { get; set; }

    public string? PomWymWymKontrahentDocelowyOrgId { get; set; }

    public string? PomWymWymKategorieFinansoweOrgId { get; set; }

    public string? PomWymWymProjektOrgId { get; set; }
}
