...
public partial class DfConfCfcardDokFlow
{
    ...
    public byte? DkoAvistaWorkMode { get; set; }

    public bool? DkoUseDefaultRepositoryLoginToRead { get; set; }

    public bool DkoRegisterGpscoordinates { get; set; }

    public bool DkoIsUsedForMobileSignatures { get; set; }

    public bool DkoBlockDeletingAttachments { get; set; }

    public bool DkoRegisterBarcodes { get; set; }
