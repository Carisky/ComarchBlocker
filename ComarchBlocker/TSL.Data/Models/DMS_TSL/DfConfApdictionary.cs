...
public partial class DfConfApdictionary
{
    ...
    public string? ApdEdorAddress { get; set; }

    public string? ApdEdorSystemName { get; set; }

    public string? ApdEdorPrivateKey { get; set; }

    public string? ApdEdorPrivateKeyFileName { get; set; }

    public string? ApdEdorToken { get; set; }

    public long? ApdEdorTokenExpires { get; set; }

    public bool ApdRemoveFromListAndEdor { get; set; }

    public byte? ApdOcrDocumentName { get; set; }

    public string? ApdTag1Name { get; set; }

    public string? ApdTag2Name { get; set; }

    public string? ApdTag3Name { get; set; }
