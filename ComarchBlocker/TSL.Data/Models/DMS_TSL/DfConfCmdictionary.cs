...
public partial class DfConfCmdictionary
{
    ...
    public string? CmdEdorAddress { get; set; }

    public string? CmdEdorSystemName { get; set; }

    public string? CmdEdorPrivateKey { get; set; }

    public string? CmdEdorPrivateKeyFileName { get; set; }

    public string? CmdEdorToken { get; set; }

    public long? CmdEdorTokenExpires { get; set; }
