...
public partial class FktZapytaniaOfertowe
{
    ...
    public virtual WymKontrahent ZosAkw { get; set; } = null!;

    public virtual WymAlokacja ZosAlokacja { get; set; } = null!;

    public virtual WymBudzet ZosBudzet { get; set; } = null!;

    public virtual WymCzasDzien ZosCzd { get; set; } = null!;

    public virtual WymDokumentNumerZapOfert ZosDokZapOfe { get; set; } = null!;

    public virtual WymKontrahent ZosKnD { get; set; } = null!;

    public virtual WymAdre ZosKndAdr { get; set; } = null!;

    public virtual WymKontrahent ZosKnt { get; set; } = null!;

    public virtual WymOperator ZosOper { get; set; } = null!;

    public virtual WymPracownik ZosOpiekun { get; set; } = null!;

    public virtual WymPrecyzjaMiary ZosPrmg { get; set; } = null!;

    public virtual WymProdukt ZosProd { get; set; } = null!;

    public virtual WymRejon ZosRejon { get; set; } = null!;

    public virtual WymStrukturaPraw? ZosStrPrw { get; set; }

    public virtual WymZrodloDanych ZosZrodg { get; set; } = null!;
}
