...
public partial class FktLimityKontrahentow
{
    ...
    public virtual WymAlokacja KnlAlokacja { get; set; } = null!;

    public virtual WymCzasDzien KnlCzdg { get; set; } = null!;

    public virtual WymKontrahent? KnlKnt { get; set; }

    public virtual WymWalutum? KnlWalutaG { get; set; }

    public virtual WymZrodloDanych KnlZrodg { get; set; } = null!;
}
