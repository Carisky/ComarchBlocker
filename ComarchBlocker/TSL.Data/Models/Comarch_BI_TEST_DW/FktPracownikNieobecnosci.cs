...
public partial class FktPracownikNieobecnosci
{
    ...
    public virtual WymAlokacja PnoAlokacja { get; set; } = null!;

    public virtual WymBudzet PnoBudzet { get; set; } = null!;

    public virtual WymCzasDzien PnoCzdg { get; set; } = null!;

    public virtual WymCzasDzien PnoCzdgiddoNavigation { get; set; } = null!;

    public virtual WymCzasDzien PnoCzdgidodNavigation { get; set; } = null!;

    public virtual WymNieobecnosc PnoNobg { get; set; } = null!;

    public virtual WymPerspektywa PnoPerspektywa { get; set; } = null!;

    public virtual WymStrukturaFirmy PnoStrFrm { get; set; } = null!;

    public virtual WymZrodloDanych PnoZrodg { get; set; } = null!;
}
