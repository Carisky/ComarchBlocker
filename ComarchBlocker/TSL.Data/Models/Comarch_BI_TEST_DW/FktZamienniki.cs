...
public partial class FktZamienniki
{
    ...
    public virtual WymAlokacja ZamAlokacja { get; set; } = null!;

    public virtual WymCzasDzien ZamCzd { get; set; } = null!;

    public virtual WymPrecyzjaMiary ZamPrmg { get; set; } = null!;

    public virtual WymProdukt ZamProd { get; set; } = null!;

    public virtual WymProdukt ZamZamiennik { get; set; } = null!;

    public virtual WymZrodloDanych ZamZrodg { get; set; } = null!;
}
