...
public partial class FktReklamacjeRealizacje
{
    ...
    public virtual WymAlokacja ReklrAlokacja { get; set; } = null!;

    public virtual WymCzasDzien ReklrCzd { get; set; } = null!;

    public virtual WymOperacjeReklamacji ReklrRkop { get; set; } = null!;

    public virtual WymRealizacjeReklamacji ReklrRkre { get; set; } = null!;

    public virtual WymZrodloDanych ReklrZrodg { get; set; } = null!;
}
