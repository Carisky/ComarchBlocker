...
public partial class BdtFktMagazynyRuchyLDokumentow
{
    public int MgrId { get; set; }

    public decimal? ZakupWalutaSystemowa { get; set; }

    public decimal? ZakupWalutaObcaWazona { get; set; }

    public decimal? WartoscKsiegowaRuch { get; set; }

    public decimal? KursWazony { get; set; }

    public decimal? KosztNabyciaRuch { get; set; }

    public decimal? IloscKsiegowaRuch { get; set; }
    ...
    public int? MgrCzrid { get; set; }

    public int? MgrCztid { get; set; }
