...
public partial class FktWm
{
    ...
    public virtual WymAlokacja WmsfAlokacjaG { get; set; } = null!;

    public virtual WymBudzet WmsfBudzetG { get; set; } = null!;
    ...
    public virtual WymDokumentNumer? WmsfDokNumerErpNavigation { get; set; }

    public virtual WymKategorieRynkowe WmsfKatRynG { get; set; } = null!;

    public virtual WymKontrahent WmsfKntG { get; set; } = null!;

    public virtual WymOperator WmsfOpeepg { get; set; } = null!;

    public virtual WymOperator WmsfOpeg { get; set; } = null!;

    public virtual WymProdukt WmsfProdG { get; set; } = null!;

    public virtual WymProjekt WmsfProjektG { get; set; } = null!;

    public virtual WymStrukturaFirmy WmsfStrFrmG { get; set; } = null!;

    public virtual WymStrukturaPraw WmsfStrPrwG { get; set; } = null!;

    public virtual WymWmsmagazyn? WmsfWmsemzg { get; set; }

    public virtual WymWmsmagazyn? WmsfWmsmcg { get; set; }

    public virtual WymWmsmagazyn WmsfWmsmg { get; set; } = null!;

    public virtual WymWmsmagazyn WmsfWmsmsg { get; set; } = null!;

    public virtual WymWmsstrukturaMagazynu? WmsfWmssdg { get; set; }

    public virtual WymWmsstrukturaMagazynu? WmsfWmssg { get; set; }

    public virtual WymWmsstrukturaMagazynu? WmsfWmssnadG { get; set; }

    public virtual WymWmsstrukturaMagazynu? WmsfWmsssg { get; set; }

    public virtual WymZrodloDanych WmsfZrodg { get; set; } = null!;
}
