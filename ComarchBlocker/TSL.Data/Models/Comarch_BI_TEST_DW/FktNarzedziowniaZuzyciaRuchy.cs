...
public partial class FktNarzedziowniaZuzyciaRuchy
{
    ...
    public virtual WymDokumentNumer NzrDokNumerG { get; set; } = null!;

    public virtual WymNarzedzium NzrNdzg { get; set; } = null!;

    public virtual WymZrodloDanych NzrZrodg { get; set; } = null!;
}
