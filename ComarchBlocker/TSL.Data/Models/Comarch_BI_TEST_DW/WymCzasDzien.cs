...
public partial class WymCzasDzien
{
    ...
    public virtual ICollection<FktMarszrutum> FktMarszrutumPmrszCzdaktywnosciDos { get; set; } = new List<FktMarszrutum>();

    public virtual ICollection<FktMarszrutum> FktMarszrutumPmrszCzdaktywnosciOds { get; set; } = new List<FktMarszrutum>();
    ...
    public virtual ICollection<FktPracownikEtaty> FktPracownikEtatyEttCzdgs { get; set; } = new List<FktPracownikEtaty>();

    public virtual ICollection<FktPracownikEtaty> FktPracownikEtatyEttCzdzatrudnienia { get; set; } = new List<FktPracownikEtaty>();

    public virtual ICollection<FktPracownikEtaty> FktPracownikEtatyEttCzdzwolnienia { get; set; } = new List<FktPracownikEtaty>();
    ...
    public virtual ICollection<FktPracownikNieobecnosci> FktPracownikNieobecnosciPnoCzdgidodNavigations { get; set; } = new List<FktPracownikNieobecnosci>();
    ...
    public virtual ICollection<FktProdukcjaZp> FktProdukcjaZpPzpCzdaktywnosciDos { get; set; } = new List<FktProdukcjaZp>();

    public virtual ICollection<FktProdukcjaZp> FktProdukcjaZpPzpCzdaktywnosciOds { get; set; } = new List<FktProdukcjaZp>();
    ...
    public virtual ICollection<FktProdukcjaZp> FktProdukcjaZpPzpCzdwystGs { get; set; } = new List<FktProdukcjaZp>();

    public virtual ICollection<FktProdukcjaZp> FktProdukcjaZpPzpCzdzakGs { get; set; } = new List<FktProdukcjaZp>();

    public virtual ICollection<FktProdukcjaZp> FktProdukcjaZpPzpCzdzamknieciaGs { get; set; } = new List<FktProdukcjaZp>();
    ...
    public virtual ICollection<FktWizytyElement> FktWizytyElementWzECzdrozpKonws { get; set; } = new List<FktWizytyElement>();

    public virtual ICollection<FktWizytyElement> FktWizytyElementWzECzdutwElemKonws { get; set; } = new List<FktWizytyElement>();

    public virtual ICollection<FktWizytyElement> FktWizytyElementWzECzdutwZads { get; set; } = new List<FktWizytyElement>();

    public virtual ICollection<FktWizytyElement> FktWizytyElementWzECzdwykElemKonws { get; set; } = new List<FktWizytyElement>();

    public virtual ICollection<FktWizytyElement> FktWizytyElementWzECzdwykZads { get; set; } = new List<FktWizytyElement>();

    public virtual ICollection<FktWizytyElement> FktWizytyElementWzECzdzakKonws { get; set; } = new List<FktWizytyElement>();
