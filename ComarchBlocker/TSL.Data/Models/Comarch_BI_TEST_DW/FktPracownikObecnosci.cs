...
public partial class FktPracownikObecnosci
{
    /// <summary>
    ...
    public virtual WymAlokacja PobAlokacja { get; set; } = null!;

    public virtual WymBudzet PobBudzet { get; set; } = null!;

    public virtual WymCzasDzien PobCzdg { get; set; } = null!;

    public virtual WymObecnosc PobObeg { get; set; } = null!;

    public virtual WymPerspektywa PobPerspektywa { get; set; } = null!;

    public virtual WymProjekt PobProjekt { get; set; } = null!;

    public virtual WymStrukturaFirmy PobStrFrm { get; set; } = null!;

    public virtual WymZrodloDanych PobZrodg { get; set; } = null!;
}
