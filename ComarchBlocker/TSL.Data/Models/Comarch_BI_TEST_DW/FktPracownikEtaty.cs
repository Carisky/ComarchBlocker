...
public partial class FktPracownikEtaty
{
    ...
    public virtual WymAlokacja EttAlokacjaG { get; set; } = null!;

    public virtual WymBudzet EttBudzetG { get; set; } = null!;

    public virtual WymCzasDzien EttCzdg { get; set; } = null!;

    public virtual WymCzasDzien EttCzdzatrudnienia { get; set; } = null!;

    public virtual WymCzasDzien EttCzdzwolnienia { get; set; } = null!;

    public virtual WymPerspektywa EttPerspektywa { get; set; } = null!;

    public virtual WymStazPracownika EttPrst { get; set; } = null!;

    public virtual WymPracownikUmowy EttPumg { get; set; } = null!;

    public virtual WymZrodloDanych EttZrodg { get; set; } = null!;
}
