...
public partial class FktZestawieniaKsiegoweErp
{
    ...
    public virtual WymZrodloDanych ZerpZrodg { get; set; } = null!;

    public virtual WymZestawieniaZmienne ZerpZsrg { get; set; } = null!;

    public virtual WymZestawieniaStruktura ZerpZszg { get; set; } = null!;
}
