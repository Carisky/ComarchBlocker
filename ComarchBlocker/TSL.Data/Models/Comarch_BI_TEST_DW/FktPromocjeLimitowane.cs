...
public partial class FktPromocjeLimitowane
{
    ...
    public virtual WymAlokacja PrmltAlokacjaG { get; set; } = null!;

    public virtual WymBudzet PrmltBudzetG { get; set; } = null!;

    public virtual WymCechy PrmltCechaG { get; set; } = null!;

    public virtual WymCzasDzien PrmltCzdg { get; set; } = null!;

    public virtual WymKontrahent PrmltDocKntG { get; set; } = null!;

    public virtual WymDokumentNumer PrmltDokNumerG { get; set; } = null!;

    public virtual WymFirma PrmltFirmaG { get; set; } = null!;

    public virtual WymFormyPlatnosci PrmltFormPlatG { get; set; } = null!;

    public virtual WymJednostka PrmltJmG { get; set; } = null!;

    public virtual WymKontrahent PrmltKntG { get; set; } = null!;

    public virtual WymLimitTyp PrmltLtg { get; set; } = null!;

    public virtual WymMagazyn PrmltMagG { get; set; } = null!;

    public virtual WymOperator PrmltOpeg { get; set; } = null!;

    public virtual WymOperator PrmltOpemg { get; set; } = null!;

    public virtual WymOperator PrmltOpewg { get; set; } = null!;

    public virtual WymOperator PrmltOpezg { get; set; } = null!;

    public virtual WymKontrahent PrmltPlatG { get; set; } = null!;

    public virtual WymPromocje PrmltPrmG { get; set; } = null!;

    public virtual WymProdukt PrmltProdG { get; set; } = null!;

    public virtual WymRodzajZakupu PrmltRdzg { get; set; } = null!;

    public virtual WymStrukturaFirmy PrmltStrFrmG { get; set; } = null!;

    public virtual WymStrukturaPraw PrmltStrPrwG { get; set; } = null!;

    public virtual WymWalutum PrmltWalutaG { get; set; } = null!;

    public virtual WymZrodloDanych PrmltZrodg { get; set; } = null!;
}
