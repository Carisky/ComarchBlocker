...
public partial class FktPracownikCzasPracy
{
    ...
    public virtual WymAlokacja PcpAlokacjaG { get; set; } = null!;

    public virtual WymBudzet PcpBudzetG { get; set; } = null!;

    public virtual WymCzasDzien PcpCzdg { get; set; } = null!;

    public virtual WymPerspektywa PcpPerspektywaG { get; set; } = null!;

    public virtual WymZrodloDanych PcpZrodg { get; set; } = null!;
}
