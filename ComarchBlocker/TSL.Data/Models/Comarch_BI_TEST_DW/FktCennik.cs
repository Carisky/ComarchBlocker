...
public partial class FktCennik
{
    ...
    public virtual WymAlokacja CenAlokacja { get; set; } = null!;

    public virtual WymCennik CenCennik { get; set; } = null!;
    ...
    public virtual WymKontrahent CenKnt { get; set; } = null!;

    public virtual WymOperator CenOpemg { get; set; } = null!;

    public virtual WymOperator CenOperator { get; set; } = null!;

    public virtual WymOperator CenOpewg { get; set; } = null!;

    public virtual WymOperator CenOpezg { get; set; } = null!;

    public virtual WymPrecyzjaMiary CenPrmg { get; set; } = null!;

    public virtual WymProdukt CenProd { get; set; } = null!;

    public virtual WymWalutum CenWaluta { get; set; } = null!;

    public virtual WymZrodloDanych CenZrodg { get; set; } = null!;
}
