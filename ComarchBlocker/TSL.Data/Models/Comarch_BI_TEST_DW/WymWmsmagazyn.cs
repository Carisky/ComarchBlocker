...
public partial class WymWmsmagazyn
{
    ...
    public virtual ICollection<FktWm> FktWmWmsfWmsemzgs { get; set; } = new List<FktWm>();

    public virtual ICollection<FktWm> FktWmWmsfWmsmcgs { get; set; } = new List<FktWm>();

    public virtual ICollection<FktWm> FktWmWmsfWmsmgs { get; set; } = new List<FktWm>();

    public virtual ICollection<FktWm> FktWmWmsfWmsmsgs { get; set; } = new List<FktWm>();
