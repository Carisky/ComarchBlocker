...
public partial class PracEtaty
{
    ...
    public byte PreUbzwlascFormaOpodatLiniowySklZus { get; set; }

    public byte PreUbzwlascFormaOpodatSkalaSklZus { get; set; }

    public byte PreUbzwlascFormaOpodatRyczaltSklZus { get; set; }

    public string PreRegon { get; set; } = null!;

    public string PreNazwaSkrocona { get; set; } = null!;

    public byte PreKartaNauczyciela { get; set; }

    public string PrePrmoddelegowanyWaluta { get; set; } = null!;
