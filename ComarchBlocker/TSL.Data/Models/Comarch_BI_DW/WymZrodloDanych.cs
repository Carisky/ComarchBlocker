...
public partial class WymZrodloDanych
{
    ...
    /// Opis źródła
    /// </summary>
    public string? ZrodOpis { get; set; }
    ...
    public virtual ICollection<WymDokumentKsef> WymDokumentKsefs { get; set; } = new List<WymDokumentKsef>();
    ...
    public virtual ICollection<WymPaczka> WymPaczkas { get; set; } = new List<WymPaczka>();
    ...
    public virtual ICollection<WymWysylka> WymWysylkas { get; set; } = new List<WymWysylka>();
