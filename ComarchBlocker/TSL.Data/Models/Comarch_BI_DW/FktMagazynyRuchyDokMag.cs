...
public partial class FktMagazynyRuchyDokMag
{
    /// <summary>
    ...
    public virtual WymCzasDzien MgmDataDostawyMagNavigation { get; set; } = null!;

    public virtual WymCzasDzien MgmDataDostawyNavigation { get; set; } = null!;

    public virtual WymCzasDzien MgmDataWplywuNavigation { get; set; } = null!;

    public virtual WymCzasDzien MgmDataZgloszeniaNavigation { get; set; } = null!;
    ...
    public virtual WymOperator MgmOpe { get; set; } = null!;

    public virtual WymOperator MgmOpem { get; set; } = null!;

    public virtual WymOperator MgmOpew { get; set; } = null!;

    public virtual WymOperator MgmOpez { get; set; } = null!;
