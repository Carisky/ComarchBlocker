...
public partial class WymRejestr
{
    ...
    public virtual WymDokumentSerium RejDokSerG { get; set; } = null!;

    public virtual WymDokumentTyp RejDokTypG { get; set; } = null!;

    public virtual WymWalutum RejWalutaG { get; set; } = null!;

    public virtual WymZrodloDanych RejZrodg { get; set; } = null!;
}
