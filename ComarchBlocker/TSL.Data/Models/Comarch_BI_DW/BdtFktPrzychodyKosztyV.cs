...
public partial class BdtFktPrzychodyKosztyV
{
    public int PkId { get; set; }

    public decimal? Mkoszt { get; set; }
    ...
    public int PkCztid { get; set; }

    public int PkCzrid { get; set; }
    ...
    public int PkRkwotyId { get; set; }

    public decimal? PkMkwota { get; set; }

    public decimal? PkMniePrzychod { get; set; }

    public decimal? PkMnieKoszt { get; set; }

    public decimal? PkMprzychod { get; set; }

    public decimal? PkMkoszt { get; set; }
