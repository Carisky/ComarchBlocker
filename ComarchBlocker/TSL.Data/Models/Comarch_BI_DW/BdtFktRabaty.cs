...
public partial class BdtFktRabaty
{
    public int RabatId { get; set; }

    public decimal? RabatZzrabatProcentPozycjaDsv { get; set; }

    public decimal? RabatZzrabatProcentDsv { get; set; }

    public decimal? RabatZzrabatDsv { get; set; }

    public decimal? RabatZkrabatProcentPozycjaDsv { get; set; }

    public decimal? RabatZkrabatProcentDsv { get; set; }

    public decimal? RabatZkrabatDsv { get; set; }

    public decimal? RabatZakupyRabatProcentPozycjaDsv { get; set; }

    public decimal? RabatZakupyRabatProcentDsv { get; set; }

    public decimal? RabatZakupyRabatDsv { get; set; }

    public decimal? RabatSprzedazRabatProcentPozycjaDsv { get; set; }

    public decimal? RabatSprzedazRabatProcentDsv { get; set; }

    public decimal? RabatSprzedazRabatDsv { get; set; }

    public decimal? RabatOzrabatProcentPozycjaDsv { get; set; }

    public decimal? RabatOzrabatProcentDsv { get; set; }

    public decimal? RabatOzrabatDsv { get; set; }

    public decimal? RabatOsrabatProcentPozycjaDsv { get; set; }

    public decimal? RabatOsrabatProcentDsv { get; set; }

    public decimal? RabatOsrabatDsv { get; set; }

    public int? RabatDokNumerZamowieniaId { get; set; }

    public int? RabatDokNumerOfertyId { get; set; }
