...
public partial class DsvFktZamowieniaZakupu
{
    ...
    public decimal? OdRealizacjiZ { get; set; }

    public decimal? OdRealizacjiZilosc { get; set; }
    ...
    public decimal? ZazMiloscRabat { get; set; }

    public decimal? ZazMiloscRealizacji { get; set; }

    public decimal? ZazMiloscRealizacjiJmP { get; set; }

    public decimal? ZazMiloscZarezerwowana { get; set; }

    public decimal? ZazMiloscZrealizowana { get; set; }

    public decimal? ZazMkgo { get; set; }

    public decimal? ZazMkgoHlp { get; set; }
    ...
    public decimal? ZazMwartoscPlnHlp { get; set; }
