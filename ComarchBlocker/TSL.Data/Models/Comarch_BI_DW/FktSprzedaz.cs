...
public partial class FktSprzedaz
{
    ...
    public int? SprDniDostawy { get; set; }

    public decimal? SprVatWartosc { get; set; }

    public int SprSpiczdprzyjeciaWydaniaOrgId { get; set; }

    public int SprSpiczdterminPlatOrgId { get; set; }

    public int SprSpiczddataRozOrgId { get; set; }

    public int SprSpiczddataWystawieniaId { get; set; }

    public int SprSpiczdzakupuOrgId { get; set; }

    public decimal? SprMkosztRzeczywistyzKk { get; set; }
    ...
    public virtual WymCzasDzien SprSpiczddataRozOrg { get; set; } = null!;

    public virtual WymCzasDzien SprSpiczddataWystawienia { get; set; } = null!;

    public virtual WymCzasDzien SprSpiczdprzyjeciaWydaniaOrg { get; set; } = null!;

    public virtual WymCzasDzien SprSpiczdterminPlatOrg { get; set; } = null!;

    public virtual WymCzasDzien SprSpiczdzakupuOrg { get; set; } = null!;
