...
public partial class BdtFktMagazynyStany
{
    public int MgsId { get; set; }

    public decimal? MgsIloczynZalegania { get; set; }
    ...
    public decimal? MgsMdniWaznosci { get; set; }

    public decimal? MgsMiloscMagStan { get; set; }

    public decimal? MgsMinne { get; set; }

    public decimal? MgsMclo { get; set; }

    public decimal? MgsMtransport { get; set; }

    public decimal? MgsMcenaZakupu { get; set; }

    public decimal? MgsMwartoscZarezerw { get; set; }

    public decimal? MgsMiloscZarezerw { get; set; }

    public decimal? MgsMobjetosc { get; set; }

    public decimal? MgsMwaga { get; set; }

    public int? MgsPozycjaId { get; set; }

    public int MgsTerminId { get; set; }

    public int MgsDokNumerMagId { get; set; }

    public int MgsDokNumerId { get; set; }

    public int MgsZaleganieId { get; set; }

    public int MgsCechaId { get; set; }

    public int MgsPartId { get; set; }
    ...
    public string? MgsWymObjGidLp { get; set; }

    public int? MgsTypKwoty { get; set; }

    public string? MgsOrgWymId { get; set; }

    public string? MgsOrgAtrId { get; set; }

    public int? MgsKierunek { get; set; }

    public int? MgsBiezace { get; set; }
    ...
    public int MgsStrFrmId { get; set; }

    public int MgsProjektId { get; set; }

    public int MgsProdStazId { get; set; }
    ...
    public int MgsLokId { get; set; }

    public int MgsKatFinId { get; set; }

    public int MgsFirmaId { get; set; }

    public int MgsCztid { get; set; }

    public int MgsCzrid { get; set; }
