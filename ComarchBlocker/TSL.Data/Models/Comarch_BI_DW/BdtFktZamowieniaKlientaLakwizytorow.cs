...
public partial class BdtFktZamowieniaKlientaLakwizytorow
{
    ...
    public decimal? CenaZakupuK { get; set; }

    public decimal? ZakMdni { get; set; }

    public decimal? ZakMiloscRabat { get; set; }

    public decimal? ZakMkgoHlp { get; set; }
    ...
    public decimal? ZakMwartoscBruttoPlnHlp { get; set; }

    public decimal? ZakMwartoscPlnHlp { get; set; }
