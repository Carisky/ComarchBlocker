...
public partial class WymKonto
{
    ...
    public virtual ICollection<FktDekrety> FktDekretyDtKontoNavigations { get; set; } = new List<FktDekrety>();

    public virtual ICollection<FktDekrety> FktDekretyDtKontoPrzGs { get; set; } = new List<FktDekrety>();
