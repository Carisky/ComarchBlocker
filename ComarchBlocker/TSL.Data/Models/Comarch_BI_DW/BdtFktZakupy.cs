...
public partial class BdtFktZakupy
{
    public int ZkpId { get; set; }

    public decimal? ZkpMzakupyZamRhwartoscWalutaHlp { get; set; }

    public decimal? ZkpMzakupyZamRhwartoscSys { get; set; }

    public decimal? ZkpMzakupyZamRhiloscJpom { get; set; }

    public decimal? ZkpMzakupyZamRhilosc { get; set; }

    public decimal? ZkpMiloscRabat { get; set; }

    public decimal? KosztyDodatkowePln { get; set; }
