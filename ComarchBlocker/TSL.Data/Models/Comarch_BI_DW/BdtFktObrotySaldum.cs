...
public partial class BdtFktObrotySaldum
{
    public int? DtOkresId { get; set; }
    ...
    public string? DtOrgId { get; set; }

    public int DtDokNumerId { get; set; }

    public string? DtKonto { get; set; }

    public decimal? BomaNie2strDsv { get; set; }

    public decimal? BomaTak2strDsv { get; set; }

    public decimal? BownNie2strDsv { get; set; }

    public decimal? BownTak2strDsv { get; set; }

    public decimal? Mboma { get; set; }

    public decimal? Mbown { get; set; }

    public int? MflagaPierwszyOkresObr { get; set; }

    public decimal? MobrotyMa { get; set; }

    public decimal? MobrotyWinien { get; set; }

    public decimal? SaldoMaNie2strDsv { get; set; }

    public decimal? SaldoMaTak2strDsv { get; set; }

    public decimal? SaldoWnNie2strDsv { get; set; }

    public decimal? SaldoWnTak2strDsv { get; set; }
    ...
    public int? DtKontoPrzId { get; set; }
}
