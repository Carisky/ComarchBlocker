...
public partial class BdtFktSprzedaz
{
    public int SprId { get; set; }

    public decimal? SrpMiloscRabat { get; set; }

    public decimal? SprMiloscHlp { get; set; }

    public decimal? SprMcenaBazowaHlp { get; set; }
    ...
    public int SprCztid { get; set; }

    public int SprCzrid { get; set; }
