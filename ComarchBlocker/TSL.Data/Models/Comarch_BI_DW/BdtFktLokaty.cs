...
public partial class BdtFktLokaty
{
    ...
    public decimal? ZapMwartoscLokataWaluta { get; set; }

    public decimal? ZapMwartoscLokata { get; set; }

    public decimal? ZapModsetkiWaluta { get; set; }

    public decimal? ZapModsetki { get; set; }
