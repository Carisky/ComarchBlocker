...
public partial class BdtFktPlatnosciRozliczone
{
    public int ZapId { get; set; }

    public decimal? ZapMwyplataIkompensacja { get; set; }

    public decimal? ZapMwplataIkompensacja { get; set; }

    public decimal? PomWyplataSop { get; set; }

    public decimal? PomWyplataSok { get; set; }

    public decimal? PomWplataSop { get; set; }

    public decimal? PomWplataSok { get; set; }
    ...
    public int ZapCztid { get; set; }

    public int ZapCzrid { get; set; }
