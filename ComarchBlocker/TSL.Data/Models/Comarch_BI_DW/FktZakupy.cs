...
public partial class FktZakupy
{
    ...
    public decimal? ZkpVatWartosc { get; set; }

    public int ZkpSpiczdterminPlatOrgId { get; set; }

    public int ZkpSpiczddataRozOrgId { get; set; }

    public int ZkpSpiczdwystawieniaOrgId { get; set; }

    public int ZkpSpiczdzakupuOrgId { get; set; }

    public int ZkpSpiczdwplywuOrgId { get; set; }

    public int ZkpSpiczdksiegowaniaOrgId { get; set; }

    public int ZkpSpiczdprzyjeciaOrgId { get; set; }

    public int ZkpOpeid { get; set; }

    public int ZkpOpemid { get; set; }

    public int ZkpOpewid { get; set; }

    public int ZkpOpezid { get; set; }

    public int ZkpDataWplywu { get; set; }

    public int ZkpDataZgloszenia { get; set; }
    ...
    public virtual WymCzasDzien ZkpDataWplywuNavigation { get; set; } = null!;

    public virtual WymCzasDzien ZkpDataZgloszeniaNavigation { get; set; } = null!;
    ...
    public virtual WymOperator ZkpOpe { get; set; } = null!;

    public virtual WymOperator ZkpOpem { get; set; } = null!;

    public virtual WymOperator ZkpOpew { get; set; } = null!;

    public virtual WymOperator ZkpOpez { get; set; } = null!;
    ...
    public virtual WymCzasDzien ZkpSpiczddataRozOrg { get; set; } = null!;

    public virtual WymCzasDzien ZkpSpiczdksiegowaniaOrg { get; set; } = null!;

    public virtual WymCzasDzien ZkpSpiczdprzyjeciaOrg { get; set; } = null!;

    public virtual WymCzasDzien ZkpSpiczdterminPlatOrg { get; set; } = null!;

    public virtual WymCzasDzien ZkpSpiczdwplywuOrg { get; set; } = null!;

    public virtual WymCzasDzien ZkpSpiczdwystawieniaOrg { get; set; } = null!;

    public virtual WymCzasDzien ZkpSpiczdzakupuOrg { get; set; } = null!;
