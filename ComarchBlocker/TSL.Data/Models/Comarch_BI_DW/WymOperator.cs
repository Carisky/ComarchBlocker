...
public partial class WymOperator
{
    ...
    public virtual ICollection<FktZakupy> FktZakupyZkpOpems { get; set; } = new List<FktZakupy>();

    public virtual ICollection<FktZakupy> FktZakupyZkpOpes { get; set; } = new List<FktZakupy>();

    public virtual ICollection<FktZakupy> FktZakupyZkpOpews { get; set; } = new List<FktZakupy>();

    public virtual ICollection<FktZakupy> FktZakupyZkpOpezs { get; set; } = new List<FktZakupy>();
