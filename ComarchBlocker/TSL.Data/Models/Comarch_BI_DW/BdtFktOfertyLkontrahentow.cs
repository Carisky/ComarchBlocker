...
public partial class BdtFktOfertyLkontrahentow
{
    ...
    public decimal? OfeMsprzedazWartoscPln { get; set; }

    public decimal? OfeMsprzedazWartosc { get; set; }

    public decimal? OfeMsprzedazWaga { get; set; }

    public decimal? OfeMsprzedazMarza { get; set; }

    public decimal? OfeMsprzedazIloscR { get; set; }

    public decimal? OfeMsprzedazIloscJmp { get; set; }

    public decimal? OfeMsprzedazIlosc { get; set; }

    public decimal? OfeMsprzedazCzasR { get; set; }

    public decimal? OfeMsprzedazCena { get; set; }

    public decimal? OfeMzakupCena { get; set; }

    public decimal? OfeMzakupCzasR { get; set; }

    public decimal? OfeMzakupIlosc { get; set; }

    public decimal? OfeMzakupIloscJmp { get; set; }

    public decimal? OfeMzakupIloscR { get; set; }

    public decimal? OfeMzakupWaga { get; set; }

    public decimal? OfeMzakupWartosc { get; set; }

    public decimal? OfeMzakupWartoscPln { get; set; }
