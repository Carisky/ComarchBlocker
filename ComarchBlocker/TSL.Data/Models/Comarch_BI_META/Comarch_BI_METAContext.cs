...
public partial class Comarch_BI_METAContext : DbContext
{
    public Comarch_BI_METAContext(DbContextOptions<Comarch_BI_METAContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EtlNode>(entity =>
        {
            ...
            entity.Property(e => e.EtlnSkipExecution).HasColumnName("ETLN_SkipExecution");
