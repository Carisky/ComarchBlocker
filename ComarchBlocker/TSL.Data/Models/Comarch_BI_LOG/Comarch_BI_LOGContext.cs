...
public partial class Comarch_BI_LOGContext : DbContext
{
    public Comarch_BI_LOGContext(DbContextOptions<Comarch_BI_LOGContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Transformation>(entity =>
        {
            ...
            entity.Property(e => e.TrnTrnpid).HasColumnName("TRN_TRNPID");
